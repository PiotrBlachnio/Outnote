...
const secrets = {
    ...
    CLOUD_STORAGE_AUTH_ENDPOINT: process.env.CLOUD_STORAGE_AUTH_ENDPOINT!,
    CLOUD_STORAGE_SERVICE_INSTANCE: process.env.CLOUD_STORAGE_SERVICE_INSTANCE!,
    CLOUD_STORAGE_BUCKET_NAME: process.env.CLOUD_STORAGE_BUCKET_NAME!
};

 ...
 * @access  Protected
*/
router.delete('/:id', auth(Roles.USER), validate.category.delete, async (req: Request, res: Response): Promise<void> => {
 ...
 * @access  Protected
*/
router.patch('/:id', auth(Roles.USER), validate.category.update, async (req: Request, res: Response): Promise<void> => {
